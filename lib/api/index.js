...
export async function getContent(opts) {
  return await request(`/content`, opts);
}

export async function getContentBySlug(slug, opts) {
  return await request(`/content/slug/${slug}`, opts);
}
